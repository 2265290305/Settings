...
dependencies {
    ...
    // Android Studio Preview loads ComposeViewAdapter from the selected variant runtime classpath.
    // Keep ui-tooling available for non-debug preview variants as well.
